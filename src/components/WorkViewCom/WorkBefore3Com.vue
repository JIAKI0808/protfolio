...
// 作品集图片数据
import meiluo01 from '../../assets/image/beforeworks3/03美萝后台-1.png';
import meiluo02 from '../../assets/image/beforeworks3/03美萝后台-2.png';
import meiluo03 from '../../assets/image/beforeworks3/03美萝后台-3.png';
import meiluo04 from '../../assets/image/beforeworks3/03美萝后台-4.png';
import meiluo05 from '../../assets/image/beforeworks3/03美萝后台-5.png';
import meiluo06 from '../../assets/image/beforeworks3/03美萝后台-6.png';
import meiluo07 from '../../assets/image/beforeworks3/03美萝后台-7.png';

const workGalleryData = ref([
  { imgUrl: meiluo01, alt: '作品集展示图片1' },
  { imgUrl: meiluo02, alt: '作品集展示图片2' },
  { imgUrl: meiluo03, alt: '作品集展示图片3' },
  { imgUrl: meiluo04, alt: '作品集展示图片4' },
  { imgUrl: meiluo05, alt: '作品集展示图片5' },
  { imgUrl: meiluo06, alt: '作品集展示图片6' },
  { imgUrl: meiluo07, alt: '作品集展示图片7' },
]);
</script>
