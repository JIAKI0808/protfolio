...
// 作品集图片数据
import yule01 from '../../assets/image/beforeworks5/05全民娱乐-1.png';
import yule02 from '../../assets/image/beforeworks5/05全民娱乐-2.png';
import yule03 from '../../assets/image/beforeworks5/05全民娱乐-3.png';
import yule04 from '../../assets/image/beforeworks5/05全民娱乐-4.png';
import yule05 from '../../assets/image/beforeworks5/05全民娱乐-5.png';
import yule06 from '../../assets/image/beforeworks5/05全民娱乐-6.png';
import yule07 from '../../assets/image/beforeworks5/05全民娱乐-7.png';

const workGalleryData = ref([
  { imgUrl: yule01, alt: '作品集展示图片1' },
  { imgUrl: yule02, alt: '作品集展示图片2' },
  { imgUrl: yule03, alt: '作品集展示图片3' },
  { imgUrl: yule04, alt: '作品集展示图片4' },
  { imgUrl: yule05, alt: '作品集展示图片5' },
  { imgUrl: yule06, alt: '作品集展示图片6' },
  { imgUrl: yule07, alt: '作品集展示图片7' },
]);
</script>
