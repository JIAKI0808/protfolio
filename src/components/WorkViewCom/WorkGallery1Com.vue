...
// 作品集图片数据
import panel01 from '../../assets/image/works1/01panel 1.png';
import panel02 from '../../assets/image/works1/01panel 2.png';
import panel03 from '../../assets/image/works1/01panel 3.png';
import panel04 from '../../assets/image/works1/01panel 4.png';
import panel05 from '../../assets/image/works1/01panel 5.png';
import panel06 from '../../assets/image/works1/01panel 6.png';
import panel07 from '../../assets/image/works1/01panel 7.png';
import panel08 from '../../assets/image/works1/01panel 8.png';
import panel09 from '../../assets/image/works1/01panel 9.png';
import panel10 from '../../assets/image/works1/01panel 10.png';

const workGalleryData = ref([
  { imgUrl: panel01, alt: '作品集展示图片1' },
  { imgUrl: panel02, alt: '作品集展示图片2' },
  { imgUrl: panel03, alt: '作品集展示图片3' },
  { imgUrl: panel04, alt: '作品集展示图片4' },
  { imgUrl: panel05, alt: '作品集展示图片5' },
  { imgUrl: panel06, alt: '作品集展示图片6' },
  { imgUrl: panel07, alt: '作品集展示图片7' },
  { imgUrl: panel08, alt: '作品集展示图片8' },
  { imgUrl: panel09, alt: '作品集展示图片9' },
  { imgUrl: panel10, alt: '作品集展示图片10' },
]);
</script>
