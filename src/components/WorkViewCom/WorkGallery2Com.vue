...
// 作品集图片数据
import web01 from '../../assets/image/works2/02web 1.png';
import web02 from '../../assets/image/works2/02web 2.png';
import web03 from '../../assets/image/works2/02web 3.png';
import web04 from '../../assets/image/works2/02web 4.png';
import web05 from '../../assets/image/works2/02web 5.png';
import web06 from '../../assets/image/works2/02web 6.png';
import web07 from '../../assets/image/works2/02web 7.png';
import web08 from '../../assets/image/works2/02web 8.png';

const workGalleryData = ref([
  { imgUrl: web01, alt: '作品集展示图片1' },
  { imgUrl: web02, alt: '作品集展示图片2' },
  { imgUrl: web03, alt: '作品集展示图片3' },
  { imgUrl: web04, alt: '作品集展示图片4' },
  { imgUrl: web05, alt: '作品集展示图片5' },
  { imgUrl: web06, alt: '作品集展示图片6' },
  { imgUrl: web07, alt: '作品集展示图片7' },
  { imgUrl: web08, alt: '作品集展示图片8' },
]);
</script>
