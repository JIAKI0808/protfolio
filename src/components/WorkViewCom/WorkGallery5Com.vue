...
// 作品集图片数据
import media01 from '../../assets/image/works5/05运营 1.png';
import media02 from '../../assets/image/works5/05运营 2.png';
import media03 from '../../assets/image/works5/05运营 3.png';
import media04 from '../../assets/image/works5/05运营 4.png';
import media05 from '../../assets/image/works5/05运营 5.png';

const workGalleryData = ref([
  { imgUrl: media01, alt: '作品集展示图片1' },
  { imgUrl: media02, alt: '作品集展示图片2' },
  { imgUrl: media03, alt: '作品集展示图片3' },
  { imgUrl: media04, alt: '作品集展示图片4' },
  { imgUrl: media05, alt: '作品集展示图片5' },
]);
</script>
