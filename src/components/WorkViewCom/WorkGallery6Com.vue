...
// 作品集图片数据
import geo01 from '../../assets/image/works6/05运营 4.png';
import geo02 from '../../assets/image/works6/05运营 5.png';
import geo03 from '../../assets/image/works6/05运营 6.png';

const workGalleryData = ref([
  { imgUrl: geo01, alt: '作品集展示图片1' },
  { imgUrl: geo02, alt: '作品集展示图片2' },
  { imgUrl: geo03, alt: '作品集展示图片3' },
]);
</script>
